...
| agency.md | 6,000 | LOL Agency state — pipeline, clients, services |
| thinklet.md | 6,000 | Thinklet SaaS state — roadmap, team, users, blockers |
| semrush.md | 3,000 | Semrush/Adobe consulting track — deliverables, contacts |
