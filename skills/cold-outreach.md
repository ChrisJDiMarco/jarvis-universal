...
```
"Hey, this is [Your Name] — I work with [vertical] companies in [city] to help them respond to leads faster. I looked at your site and noticed [GAP]. Is that something you've thought about solving?"
```
...
4. Set follow-up task in GHL for operator review if no response in 72h
