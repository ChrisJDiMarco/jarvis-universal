...
1. **The absolute file path** (e.g. `/Users/chrisdimarco/jarvis/owners-inbox/competitive-brief-2026-05-05.md`)
...
[View it](computer:///Users/chrisdimarco/jarvis/[path])
```
...
```json
{
  "path": "/Users/chrisdimarco/jarvis/owners-inbox/foo.md",
...
- [ ] Path is absolute and uses the workspace folder Chris can open
