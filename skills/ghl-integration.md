...
When reporting pipeline status to the operator, always use this format:
...
- If the bridge returns an error: log it, do not retry automatically, report to the operator with full error context
