...
| Zone | What | Lifetime |
|------|------|----------|
| `team-inbox/` | **Files** Chris drops for JARVIS to process (CSVs, screenshots, docs) | Until processed, then archived |
| `owners-inbox/` | **Outputs** JARVIS produces for Chris to review | 7 days, then auto-archived |
